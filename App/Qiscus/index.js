...
export function setDeviceToken(token) {
  console.tron.log("qiscus.isLogin", qiscus.isLogin);
  console.tron.log("qiscus.userData", qiscus.userData);
  ...
  return axios
    ...
    .then(res => {
      console.tron.log("success sending device token", res);
    })
    .catch(error => {
      console.tron.log("failed sending device token", error);
    });
}
